...
const createAccount = catchAsync( async (req: Request, res: Response) => {
  ...
  const result = await StripeServices.createDeliveryPersonRecipient(user.id, req.body);
...
const saveCardWithCustomerInfo = catchAsync( async (req: Request, res: Response) => {
  const user = req.user as any;
  const result = await StripeServices.saveCardWithCustomerInfoIntoPaystack(
    req.body,
    user
  );
...
const capturePaymentRequest = catchAsync( async (req: any, res: any) => {
  ...
  const result = await StripeServices.capturePaymentRequestToPaystack(user.id, req.body);
