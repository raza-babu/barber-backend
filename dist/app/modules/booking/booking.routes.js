...
router.get('/walking-in/barbers/:saloonId', (0, auth_1.default)(client_1.UserRoleEnum.SALOON_OWNER, client_1.UserRoleEnum.CUSTOMER), 
...
router.get('/walking-in/barbers/:saloonId/:barberId', (0, auth_1.default)(client_1.UserRoleEnum.SALOON_OWNER, client_1.UserRoleEnum.CUSTOMER), 
// validateRequest(bookingValidation.walkingInBarbersSchema),
...
router.patch('/cancel-booking/:id', (0, auth_1.default)(client_1.UserRoleEnum.CUSTOMER), booking_controller_1.bookingController.cancelBooking);
