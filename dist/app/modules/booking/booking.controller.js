...
const createBooking = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.body.type === client_1.BookingType.QUEUE) {
        if (user.role === client_1.UserRoleEnum.SALOON_OWNER) {
            const result = yield booking_service_1.bookingService.createQueueBookingForSalonOwnerIntoDb(user.id, req.body);
            return (0, sendResponse_1.default)(res, {
                statusCode: http_status_1.default.CREATED,
                success: true,
                message: 'Queue booking created successfully for salon owner',
                data: result,
            });
        }
        if (user.role === client_1.UserRoleEnum.CUSTOMER) {
            if (!req.body.barberId) {
                const result = yield booking_service_1.bookingService.createQueueBookingForCustomerIntoDb(user.id, req.body.saloonOwnerId, req.body);
                return (0, sendResponse_1.default)(res, {
                    statusCode: http_status_1.default.CREATED,
                    success: true,
...
const getAvailableBarbers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (parsed.query.type === client_1.BookingType.QUEUE) {
        const result = yield booking_service_1.bookingService.getAvailableBarbersForQueueFromDb(user.id, parsed.query);
        (0, sendResponse_1.default)(res, {
            statusCode: http_status_1.default.OK,
            success: true,
    ...
    if (parsed.query.type === client_1.BookingType.BOOKING) {
...
const updateBooking = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield booking_service_1.bookingService.updateBookingIntoDb(user.id, req.body, req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
