...
const getBarberByIdFromDb = (userId, barberId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return Object.assign(Object.assign({ isMe: userId === barberId }, rest), { followerCount: result.user.followerCount, followingCount: result.user.followingCount, isFollowing: isFollowing ? true : false });
});
