...
exports.saloonScheduleValidation = exports.createSaloonScheduleSchema = exports.singleDayScheduleSchema = void 0;
const zod_1 = require("zod");
// Enhanced time format validation
const timeFormatRegex = /^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/; // 00:00 to 23:59
exports.singleDayScheduleSchema = zod_1.z.object({
...
exports.createSaloonScheduleSchema = zod_1.z.object({
    body: zod_1.z.array(exports.singleDayScheduleSchema)
        .length(7)
        .refine(days => {
...
const updateSaloonScheduleSchema = zod_1.z.object({
    body: zod_1.z.object({
        dayOfWeek: zod_1.z
            ...
            .optional(),
        openingTime: zod_1.z.string().regex(/^([01]\d|2[0-3]):([0-5]\d)$/, 'Opening time must be in HH:mm format').optional(),
        closingTime: zod_1.z.string().regex(/^([01]\d|2[0-3]):([0-5]\d)$/, 'Closing time must be in HH:mm format').optional(),
...
exports.saloonScheduleValidation = {
    createSaloonScheduleSchema: exports.createSaloonScheduleSchema,
