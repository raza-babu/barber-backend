...
const getBarberScheduleList = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield barberSchedule_service_1.barberScheduleService.getBarberScheduleListFromDb();
    (0, sendResponse_1.default)(res, {
...
const getBarberScheduleById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield barberSchedule_service_1.barberScheduleService.getBarberScheduleByIdFromDb(req.params.id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
